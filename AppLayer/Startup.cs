...
namespace AppLayer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITeamLeaderRepo, TeamLeaderRepo>();
            services.AddTransient<ISprintRepo, SprintRepo>();
            services.AddTransient<IDutyRepo, DutyRepo>();
            services.AddTransient<IStatusRepo, StatusRepo>();
            services.AddTransient<IWorkReop, WorkRepo>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute(
                    name: "ProjectManager",
                    pattern: "{controller=Project}/{action=PMProjects}/{id?}");
